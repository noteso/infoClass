...
<html lang="en">
    <head>
        ...
        <title>Homework || infoClass</title>
    </head>
    <body>
        ...
        <div class="container shadow-lg rounded">
            <div class="row justify-content-center" style="height: calc(100vh - 75px);">
                <div class="d-none d-lg-block col-lg-3 border-end border-secondary border-end-2">
                    ...
                    <a href="../homework/?c=<?php echo $_GET['c']; ?>" class="d-block btn text-primary bg-light fw-bold border border-primary mb-2 text-start"><i class="bi bi-check2-square"></i> Homework</a> 
                ...
                <div class="col col-sm-10 col-md-10 col-lg-8" style="height: calc(100vh - 75px);">
                    <div class="overflow-auto pb-5" style="height: calc(100vh - 140px);" id="homeworkholder">
                    ...
                    <div class="d-flex justify-content-center bg-light sticky-bottom" style="height: 65px;">
                        <button class="btn btn-primary bg-light text-primary border border-primary rounded-2 h-75 my-auto" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvastest" aria-controls="offcanvastest">
                            <div class="fw-bold"><i class="bi bi-plus-lg"></i> Book Homework</div>    
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div class="offcanvas offcanvas-start" tabindex="-1" id="navbarOffcanvasLg" aria-labelledby="menucanvas">
            ...
            <div class="offcanvas-body">
                ...
                <a href="../homework/?c=<?php echo $_GET['c']; ?>" class="d-block btn text-primary bg-light fw-bold border border-primary my-3 text-start"><i class="bi bi-check2-square"></i> Homework</a>
        ...
        <?php include_once "../php/bookhomeworksnip.php" ?>

        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-OERcA2EqjJCMA+/3y+gxIOqMEjwtxJY7qPCqsdltbNJuaOe923+mo//f6V8Qbsw3" crossorigin="anonymous"></script>

        <script src="./js/bookhomework.js"></script>
        <script src="./js/gethomework.js"></script>
