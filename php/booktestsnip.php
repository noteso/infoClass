...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvastest" aria-labelledby="testoffcanvas">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title text-primary" id="testoffcanvas">Book New Test</h5>
    ...
    <div class="offcanvas-body">
        ...
        <form action="#" method="post" id="booktestform">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" name="description" id="description" placeholder="This test will have....." rows="3"></textarea>
            </div>
            <div class="mb-3">
            ...
            <button id="booktestbutton" type="submit" class="btn btn-primary float-end">Submit</button>                    
        </form>
    </div>
</div>